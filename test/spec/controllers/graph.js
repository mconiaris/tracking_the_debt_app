...
describe('Controller: GraphCtrl', function () {
  ...
  describe('value of graph year', function() {
    ...
    function yearTest(graphIndex, year) {
      it('in scope.graphs[0].data[0][' + graphIndex + '] should not be null', function() {
        expect(scope.graphs[0].data[graphIndex][0]).toEqual(jasmine.anything());
      });
      it('in scope.graphs[0].data[0][' + graphIndex + '] should be a Number', function () {
        expect(scope.graphs[0].data[graphIndex][0]).toEqual(jasmine.any(Number));
      });
  ...
  // ================================
  // graphs[1].data[x] Array confirmation tests
  // ================================

  describe('scope.graphs[1].data[x]', function() {

    var graphIndex = 0;

    function arrayTest(graphIndex) {
      it('scope.graphs[1].data[' + graphIndex + '] should be an Array', function () {
        expect(scope.graphs[1].data[graphIndex]).toEqual(jasmine.any(Array));
      });
    }
  ...
  describe('value of graph year', function() {
    ...
    function yearTest(graphIndex, year) {
      it('in scope.graphs[1].data[0][' + graphIndex + '] should not be null', function() {
        expect(scope.graphs[1].data[graphIndex][0]).toEqual(jasmine.anything());
      });
      it('in scope.graphs[1].data[0][' + graphIndex + '] should be a Number', function () {
        expect(scope.graphs[1].data[graphIndex][0]).toEqual(jasmine.any(Number));
      });
      it('in scope.graphs[1].data[0][' + graphIndex + '] should equal \'' + year + '\'', function () {
        expect(scope.graphs[1].data[graphIndex][0]).toBe(year);
      });
    }
  ...
  // ================================
  // graphs[2].data[x] Array confirmation tests
  // ================================

  describe('scope.graphs[2].data[x]', function() {

    var graphIndex = 0;

    function arrayTest(graphIndex) {
      it('scope.graphs[2].data[' + graphIndex + '] should be an Array', function () {
        expect(scope.graphs[2].data[graphIndex]).toEqual(jasmine.any(Array));
      });
    }
  ...
  describe('value of graph year', function() {
    ...
    function yearTest(graphIndex, year) {
      it('in scope.graphs[2].data[0][' + graphIndex + '] should not be null', function() {
        expect(scope.graphs[2].data[graphIndex][0]).toEqual(jasmine.anything());
      });
      it('in scope.graphs[2].data[0][' + graphIndex + '] should be a Number', function () {
        expect(scope.graphs[2].data[graphIndex][0]).toEqual(jasmine.any(Number));
      });
  ...
  describe('scope.graphs[2].data', function() {
    it('should have 80 items in it', function() {
      expect(scope.graphs[2].data.length).toEqual(80);
    });
  });
  ...
  describe('scope.graphs[3].data', function() {
    it('should have 80 items in it', function() {
      expect(scope.graphs[3].data.length).toEqual(80);
    });
  });
  ...
  // ================================
  // graphs[4].data[x] Array confirmation tests
  // ================================

  describe('scope.graphs[4].data[x]', function() {

    var graphIndex = 0;

    function arrayTest(graphIndex) {
      it('scope.graphs[4].data[' + graphIndex + '] should be an Array', function () {
        expect(scope.graphs[4].data[graphIndex]).toEqual(jasmine.any(Array));
      });
    }
  ...
  // ================================
  // graphs[5].data[x] Array confirmation tests
  // ================================

  describe('scope.graphs[5].data[x]', function() {

    var graphIndex = 0;

    function arrayTest(graphIndex) {
      it('scope.graphs[5].data[' + graphIndex + '] should be an Array', function () {
        expect(scope.graphs[5].data[graphIndex]).toEqual(jasmine.any(Array));
      });
    }
  ...
  describe('scope.graphs[5].data', function() {
    it('should have 80 items in it', function() {
      expect(scope.graphs[5].data.length).toEqual(80);
    });
  });
